...
! function(t) {
	...
	r.prototype.cache = n, r.prototype.define = function(t, e) {
		...
		function s(t, e) {
			...
			("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[v] = e, d
				.removeChild(g),
				function o() {
					return ++h > 1e3 * n.timeout / 4 ? a(v + " is not a valid module", "error") : void(n.status[v] ?
						p() : setTimeout(o, 4))
				}())
		}
		...
		function p() {
			l.push(layui[v]), t.length > 1 ? f.use(t.slice(1), r, l, c) : "function" == typeof r && function() {
				return layui.jquery && "function" == typeof layui.jquery && "define" !== c ? layui.jquery(
					function() {
						r.apply(layui, l)
		...
		var v = t[0],
			h = 0;
		if (l = l || [], n.host = n.host || (y.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 ===
			t.length || layui["layui.all"] && u[v]) return p(), f;
		var m = (u[v] ? y + "modules/" : /^\{\/\}/.test(f.modules[v]) ? "" : n.base || "") + (f.modules[v] || v) +
			".js";
		if (m = m.replace(/^\{\/\}/, ""), !n.modules[v] && layui[v] && (n.modules[v] = m), n.modules[v]) !
			function b() {
				return ++h > 1e3 * n.timeout / 4 ? a(v + " is not a valid module", "error") : void("string" ==
					typeof n.modules[v] && n.status[v] ? p() : setTimeout(b, 4))
			}();
		else {
			...
			g.async = !0, g.charset = "utf-8", g.src = m + function() {
				...
				return t ? "?v=" + t : ""
			}(), d.appendChild(g), !g.attachEvent || g.attachEvent.toString && g.attachEvent.toString().indexOf(
				"[native code") < 0 || i ? g.addEventListener("load", function(t) {
				s(t, m)
		...
		return l.rel = "stylesheet", l.href = t + (n.debug ? "?v=" + (new Date).getTime() : ""), l.media = "all", e
			.getElementById(s) || u.appendChild(l), "function" != typeof r ? i : (function y(o) {
				var u = 100,
					l = e.getElementById(s);
				return ++f > 1e3 * n.timeout / u ? a(t + " timeout") : void(1989 === parseInt(i.getStyle(l,
		...
		return e ? (r.sort(function(t, n) {
			var r = /^-?\d+$/,
				o = t[e],
				a = n[e];
			return r.test(o) && (o = parseFloat(o)), r.test(a) && (a = parseFloat(a)), o && !a ? 1 : !
				o && a ? -1 : o > a ? 1 : o < a ? -1 : 0
		}), n && r.reverse(), r) : r
		...
		{}, n.event[l][c] = [o], this) : (layui.each(n.event[l], function(t, e) {
			return "{*}" === c ? void layui.each(e, s) : ("" === t && layui.each(e, s), void(c && t ===
				c && layui.each(e, s)))
		}), i)
...
! function() {
	...
	var t = "lay",
		...
		r = function(t) {
			for (var n = 0, r = "object" == typeof t ? [t] : (this.selector = t, e.querySelectorAll(t || null)); n < r
				.length; n++) this.push(r[n])
		};
	r.prototype = [], r.prototype.constructor = r, n.extend = function() {
		...
		var u = (o || t).replace(/\.|\//g, ""),
			...
			s = "creating",
			l = 0;
		c.rel = "stylesheet", c.href = t, c.id = a, e.getElementById(a) || i.appendChild(c), "function" ==
			typeof r && ! function f(t) {
				var o = 100,
					i = e.getElementById(a);
				return ++l > 1e4 / o ? window.console && console.error(u + ".css: Invalid") : void(1989 ===
					parseInt(n.getStyle(i, "width")) ? (t === s && i.removeAttribute("lay-status"), i
						.getAttribute("lay-status") === s ? setTimeout(f, o) : r()) : (i.setAttribute(
						"lay-status", s), setTimeout(function() {
						f(s)
					}, o)))
			}()
		...
		if (r) {
			...
			var i = "right" === o.clickType ? function() {
				...
				f = i.left,
				h = i.bottom;
			f + c + l > s("width") && (f = s("width") - c - l), h + u + l > s() && (i.top > u + l ? h = i.top - u -
				2 * l : "right" === o.clickType && (h = s() - u - 2 * l, h < 0 && (h = 0)));
			var p = o.position;
			if (p && (r.style.position = p), r.style.left = f + ("fixed" === p ? 0 : a(1)) + "px", r.style.top = h +
				("fixed" === p ? 0 : a()) + "px", !n.hasScrollbar()) {
...
! function(e) {
	...
	v.isLeapYear = function(e) {
		...
		a.elem = lay(a.elem), a.eventElem = lay(a.eventElem), a.elem[0] && (a.range === !0 && (a.range = "-"), i[a
				.type] || (e.console && console.error && console.error("laydate type error:'" + a.type +
				"' is not supported"), a.type = "date"), a.format === i.date && (a.format = i[a.type] || i
			.date), t.format = a.format.match(new RegExp(n + "|.", "g")) || [], t.EXP_IF = "", t.EXP_SPLIT = "",
			lay.each(t.format, function(e, a) {
				var l = new RegExp(n).test(a) ? "\\d{" + function() {
					return new RegExp(n).test(t.format[0 === e ? e + 1 : e - 1] || "") ? /^yyyy|y$/
						.test(a) ? 4 : a.length : /^yyyy$/.test(a) ? "1,4" : /^y$/.test(a) ? "1,308" :
						"1,2"
				}() + "}" : "\\" + a;
				t.EXP_IF = t.EXP_IF + l, t.EXP_SPLIT = t.EXP_SPLIT + "(" + l + ")"
			}), t.EXP_IF = new RegExp("^" + (a.range ? t.EXP_IF + "\\s\\" + a.range + "\\s" + t.EXP_IF : t
				.EXP_IF) + "$"), t.EXP_SPLIT = new RegExp("^" + t.EXP_SPLIT + "$", ""), t.isInput(a.elem[0]) ||
			"focus" === a.trigger && (a.trigger = "click"), a.elem.attr("lay-key") || (a.elem.attr("lay-key", t
				.index), a.eventElem.attr("lay-key", t.index)), a.mark = lay.extend({}, a.calendar && "cn" === a
				.lang ? {
					"0-1-1": "元旦",
					"0-2-14": "情人",
					"0-3-8": "妇女",
				...
				if ("number" == typeof a[t]) {
					...
					n = [s.getFullYear(), s.getMonth() + 1, s.getDate()], i < o || (l = [s.getHours(), s
						.getMinutes(), s.getSeconds()
					])
				} else n = (a[t].match(/\d+-\d+-\d+/) || [""])[0].split("-"), l = (a[t].match(
					/\d+:\d+:\d+/) || [""])[0].split(":");
				a[t] = {
			...
			}), t.elemID = "layui-laydate" + a.elem.attr("lay-key"), (a.show || l) && t.render(), l || t
			.events(), a.value && a.isInitValue && (a.value.constructor === Date ? t.setValue(t.parse(0, t
		...
		var e = this,
			...
			l = e.elem = lay.elem("div", {
				id: e.elemID,
				"class": ["layui-laydate", t.range ? " layui-laydate-range" : "", n ? " " + d : "", t.theme &&
		...
		if (t.zIndex && (l.style.zIndex = t.zIndex), lay.each(new Array(2), function(e) {
				...
				return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' +
					a.timeTips + "</span>"), lay.each(t.btns, function(e, i) {
					var r = a.tools[i] || "btn";
					t.range && "now" === i || (n && "clear" === i && (r = "cn" === t.lang ? "重置" :
						"Reset"), l.push('<span lay-type="' + i + '" class="laydate-btns-' + i +
						'">' + r + "</span>"))
			...
			var m = lay.elem("style"),
				c = ["#{{id}} .layui-laydate-header{background-color:{{theme}};}",
			...
			"styleSheet" in m ? (m.setAttribute("type", "text/css"), m.styleSheet.cssText = c) : m.innerHTML = c,
				lay(l).addClass("laydate-theme-molv"), l.appendChild(m)
		}
		e.remove(v.thisElemDate), n ? t.elem.append(l) : (document.body.appendChild(l), e.position()), e.checkDate()
			.calendar(null, 0, "init"), e.changeEvent(), v.thisElemDate = e.elemID, "function" == typeof t.ready &&
			t.ready(lay.extend({}, t.dateTime, {
		...
		t.elem && (a.innerHTML = e || "", lay(t.elem).find("." + u).remove(), t.elem.appendChild(a), clearTimeout(t
		...
		var t, a, l = this,
			...
			d = (l.isInput(s) ? "val" : "html", l.isInput(s) ? s.value : "static" === i.position ? "" : s
			.innerHTML),
			m = function(e) {
				e.year > y[1] && (e.year = y[1], a = !0), e.month > 11 && (e.month = 11, a = !0), e.hours > 23 && (e
			...
			c = function(e, t, n) {
				...
				t = (t.match(l.EXP_SPLIT) || []).slice(1), n = n || 0, i.range && (l[r[n]] = l[r[n]] || {}), lay
					.each(l.format, function(o, s) {
						var d = parseFloat(t[o]);
						t[o].length < s.length && (a = !0), /yyyy|y/.test(s) ? (d < y[0] && (d = y[0], a = !0),
								e.year = d) : /MM|M/.test(s) ? (d < 1 && (d = 1, a = !0), e.month = d - 1) :
							/dd|d/.test(s) ? (d < 1 && (d = 1, a = !0), e.date = d) : /HH|H/.test(s) ? (d < 1 &&
								(d = 0, a = !0), e.hours = d, i.range && (l[r[n]].hours = d)) : /mm|m/.test(s) ?
							(d < 1 && (d = 0, a = !0), e.minutes = d, i.range && (l[r[n]].minutes = d)) : /ss|s/
							.test(s) && (d < 1 && (d = 0, a = !0), e.seconds = d, i.range && (l[r[n]].seconds =
								d))
					}), m(e)
			};
		return "limit" === e ? (m(o), l) : (d = d || i.value, "string" == typeof d && (d = d.replace(/\s+/g, " ")
				.replace(/^\s|\s$/g, "")), i.range && (l.endDate = l.endDate || lay.extend({}, o, function() {
				var e = {},
					t = l.getAsYM(o.year, o.month);
				return "year" === i.type ? e.year = o.year + 1 : "time" !== i.type && (e.year = t[0], e
					.month = t[1]), e
			}())), "string" == typeof d && d ? l.EXP_IF.test(d) ? i.range ? (d = d.split(" " + i.range + " "),
				lay.each([i.dateTime, l.endDate], function(e, t) {
					c(t, d[e], e)
				})) : c(o, d) : (l.hint(r.formatError[0] + (i.range ? i.format + " " + i.range + " " + i
				.format : i.format) + r.formatError[1]), a = !0) : d && d.constructor === Date ? i.dateTime = l
			.systemDate(d) : (i.dateTime = l.systemDate(), delete l.startTime, delete l.endTime), m(o), a &&
			d && l.setValue(i.range ? l.endDate ? l.parse() : "" : l.parse()), e && e(), l)
		...
		return m.year < y[0] && (m.year = y[0], s.hint(u.invalidDate)), m.year > y[1] && (m.year = y[1], s.hint(u
				.invalidDate)), s.firstDate || (s.firstDate = lay.extend({}, m)), c.setFullYear(m.year, m.month, 1),
			l = c.getDay(), i = n.getEndDate(m.month || 12, m.year), r = n.getEndDate(m.month + 1, m.year), lay
			.each(p, function(e, t) {
				var a = [m.year, m.month],
					n = 0;
				t = lay(t), t.removeAttr("class"), e < l ? (n = i - l + e, t.addClass("laydate-day-prev"), a = s
						.getAsYM(m.year, m.month, "sub")) : e >= l && e < r + l ? (n = e - l, n + 1 === m
						.date && t.addClass(o)) : (n = e - r - l, t.addClass("laydate-day-next"), a = s.getAsYM(
						m.year, m.month)), a[1]++, a[2] = n + 1, t.attr("lay-ymd", a.join("-")).html(a[2]), s
					.mark(t, a).limit(t, {
						year: a[0],
						month: a[1] - 1,
						date: a[2]
					}, e)
			}), lay(g[0]).attr("lay-ym", m.year + "-" + (m.month + 1)), lay(g[1]).attr("lay-ym", m.year + "-" + (m
				.month + 1)), "cn" === d.lang ? (lay(g[0]).attr("lay-type", "year").html(m.year + "年"), lay(g[1])
				.attr("lay-type", "month").html(m.month + 1 + "月")) : (lay(g[0]).attr("lay-type", "month").html(u
				.month[m.month]), lay(g[1]).attr("lay-type", "year").html(m.year)), h && (d.range ? e && (s
				.listYM = [
					[d.dateTime.year, d.dateTime.month + 1],
					[s.endDate.year, s.endDate.month + 1]
				], s.list(d.type, 0).list(d.type, 1), "time" === d.type ? s.setBtnStatus("时间", lay.extend({}, s
					.systemDate(), s.startTime), lay.extend({}, s.systemDate(), s.endTime)) : s.setBtnStatus(!0)
				) : (s.listYM = [
				[m.year, m.month + 1]
			], s.list(d.type, 0))), d.range && "init" === a && !e && s.calendar(s.endDate, 1), d.range || s.limit(
				lay(s.footer).find(f), null, 0, ["hours", "minutes", "seconds"]), s.setBtnStatus(), s.stampRange(t,
				p), s
		...
		if (D[0] < 1 && (D[0] = 1), "year" === e) {
			...
			w < 1 && (w = C = 1), lay.each(new Array(15), function(e) {
				...
				C == D[0] && lay(l).addClass(o), l.innerHTML = C + T, y.appendChild(l), C < a.firstDate
					.year ? (i.month = n.min.month, i.date = n.min.date) : C >= a.firstDate.year && (i
						.month = n.max.month, i.date = n.max.date), a.limit(lay(l), i, t), C++
			...
			e + 1 == D[1] && lay(l).addClass(o), l.innerHTML = i.month[e] + (v ? "月" : ""), y.appendChild(
				l), D[0] < a.firstDate.year ? r.date = n.min.date : D[0] >= a.firstDate.year && (r.date = n
					.max.date), a.limit(lay(l), r, t)
			...
			n.range ? a[x] || (a[x] = {
				...
				lay.each(new Array(t), function(t) {
					l.push("<li" + (a[x][M[e]] === t ? ' class="' + o + '"' : "") + ">" + lay.digit(
						t, 2) + "</li>")
				}), n.innerHTML = l.join("") + "</ol>", y.appendChild(n)
			}), k()
		}
		if (h && u.removeChild(h), u.appendChild(y), "year" === e || "month" === e) lay(a.elemMain[t]).addClass(
			"laydate-ym-show"), lay(y).find("li").on("click", function() {
			...
			if (!lay(this).hasClass(s)) {
				...
				d ? (lay(y).find("." + o).removeClass(o), lay(this).addClass(o), "month" === n.type &&
						"year" === e && (a.listYM[t][0] = i, r && (t ? l.year = i : a.endDate.year = i), a
							.list("month", t))) : (a.checkDate("limit").calendar(null, t), a.closeList()), a
					.setBtnStatus(), n.range || (("month" === n.type && "month" === e || "year" === n
						.type && "year" === e) && a.setValue(a.parse()).remove().done(), a.done(null,
						"change")), lay(a.footer).find(g).removeClass(s)
			}
		});
		else {
			var E = lay.elem("span", {
				...
				H = lay(d[2]).find("." + p);
			b(), E.innerHTML = n.range ? [i.startTime, i.endTime][t] : i.timeTips, lay(a.elemMain[t]).addClass(
				"laydate-time-show"), H[0] && H.remove(), d[2].appendChild(E), lay(y).find("ol").each(function(
				e) {
				var t = this;
				lay(t).find("li").on("click", function() {
					var i = 0 | this.innerHTML;
					lay(this).hasClass(s) || (n.range ? a[x][M[e]] = i : l[M[e]] = i, lay(t).find(
							"." + o).removeClass(o), lay(this).addClass(o), k(), b(), (a
		...
		i.range && "time" !== i.type && (t = t || i.dateTime, a = a || l.endDate, n = l.newDate(t).getTime() > l
			.newDate(a).getTime(), l.limit(null, t) || l.limit(null, a) ? o.addClass(s) : o[n ? "addClass" :
				"removeClass"](s), e && n && l.hint("string" == typeof e ? r.timeout.replace(/日期/g, e) : r
				.timeout))
	}, v.prototype.parse = function(e, t) {
		var a = this,
			n = a.config,
			l = t || (e ? lay.extend({}, a.endDate, a.endTime) : n.range ? lay.extend({}, n.dateTime, a.startTime) :
				n.dateTime),
			i = a.format.concat();
		return lay.each(i, function(e, t) {
			/yyyy|y/.test(t) ? i[e] = lay.digit(l.year, t.length) : /MM|M/.test(t) ? i[e] = lay.digit(l
					.month + 1, t.length) : /dd|d/.test(t) ? i[e] = lay.digit(l.date, t.length) : /HH|H/
				.test(t) ? i[e] = lay.digit(l.hours, t.length) : /mm|m/.test(t) ? i[e] = lay.digit(l
					.minutes, t.length) : /ss|s/.test(t) && (i[e] = lay.digit(l.seconds, t.length))
		...
		var a, n, l = this,
			i = l.config;
		i.range && (a = l.newDate(i.dateTime).getTime(), n = l.newDate(l.endDate).getTime(), lay.each(t, function(t,
			i) {
		...
		i = {
			...
			}), a.calendar(null, t)) : "static" === n.position ? a.calendar().done().done(null, "change") :
			"date" === n.type ? a.setValue(a.parse()).remove().done() : "datetime" === n.type && a.calendar()
			.done(null, "change"))
		...
		var a = this,
			...
			o = {
				datetime: function() {
					lay(e).hasClass(s) || (a.list("time", 0), n.range && a.list("time", 1), lay(e).attr(
				...
				clear: function() {
					a.setValue("").remove(), r && (lay.extend(i, a.firstDate), a.calendar()), n.range && (
						delete a.endDate, delete a.startTime, delete a.endTime), a.done(["", {}, {}])
				},
				now: function() {
					var e = new Date;
				...
				confirm: function() {
					if (n.range) {
						if (lay(e).hasClass(s)) return a.hint("time" === n.type ? l.timeout.replace(/日期/g,
							"时间") : l.timeout)
		...
		var t = this,
			...
			o = function(o) {
				...
				return s && (r[0] = o ? r[0] - 15 : r[0] + 15, t.list("year", e)), y && (o ? r[0]-- : r[0]++, t
					...
					year: r[0]
				}), l && (n.year = r[0]), a.range || t.done(null, "change"), a.range || t.limit(lay(t
					.footer).find(f), {
					year: r[0]
				})), t.setBtnStatus(), s || y
			};
		return {
			prevYear: function() {
				o("sub") || (n.year--, t.checkDate("limit").calendar(null, e), a.range || t.done(null,
					"change"))
			},
			prevMonth: function() {
		...
		lay(e.elem).on("click", function(e) {
			...
			lay(a[0]).on("click", function(a) {
				...
				var n = lay(this),
					l = n.attr("lay-ym"),
					i = n.attr("lay-type");
				l && (l = l.split("-"), e.listYM[t] = [0 | l[0], 0 | l[1]], e.list(i, t), lay(e
					.footer).find(g).addClass(s))
		...
		a.elem[0] && !a.elem[0].eventHandler && (n(a.elem, "bind"), n(a.eventElem), lay(document).on("click",
			function(e) {
				e.target !== a.elem[0] && e.target !== a.eventElem[0] && e.target !== lay(a.closeStop)[0] &&
					t.remove()
			}).on("keydown", function(e) {
			13 === e.keyCode && lay("#" + t.elemID)[0] && t.elemID === v.thisElemDate && (e
				.preventDefault(), lay(t.footer).find(f)[0].click())
				...
				var f = "layui-layer-wrap",
					c = function() {
						if (a === o.type[1] && "object" === n.attr("conType")) {
							...
							if (a === o.type[2]) try {
								var c = i("#" + l[4] + e)[0];
								c.contentWindow.document.write(""), c.contentWindow.close(), n.find(
									"." + l[5])[0].removeChild(c)
							} catch (u) {}
							n[0].innerHTML = "", n.remove()
						}
						"function" == typeof o.end[e] && o.end[e](), delete o.end[e], "function" ==
							typeof t && t()
					};
				n.data("isOutAnim") && n.addClass("layer-anim " + s), i(
						"#layui-layer-moves, #layui-layer-shade" + e).remove(), 6 == r.ie && o.reselect(), o
					.rescollbar(e), n.attr("minLeft") && (o.minIndex--, o.minLeft.push(n.attr("minLeft"))),
	...
	var t = layui.$,
		i = {
			fixbar: function(e) {
				...
				t("." + n)[0] || ("object" == typeof e.css && g.css(e.css), l.append(g), s(), g.find("li")
					.on("click", function() {
						var i = t(this),
							a = i.attr("lay-type");
			...
			timeAgo: function(e, t) {
				...
				return n > 26784e5 ? (n = new Date(e), a[0][0] = i.digit(n.getFullYear(), 4), a[0][1] = i
						.digit(n.getMonth() + 1), a[0][2] = i.digit(n.getDate()), t || (a[1][0] = i.digit(n
			...
			toDateString: function(e, t) {
				...
				return t = t || "yyyy-MM-dd HH:mm:ss", t.replace(/yyyy/g, n[0]).replace(/MM/g, n[1])
					.replace(/dd/g, n[2]).replace(/HH/g, o[0]).replace(/mm/g, o[1]).replace(/ss/g, o[2])
			},
			escape: function(e) {
				return String(e || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;")
					.replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;")
			...
			event: function(e, a, n) {
				var o = t("body");
				return n = n || "click", a = i.event[e] = t.extend(!0, i.event[e], a) || {}, i.event
					.UTIL_EVENT_CALLBACK = i.event.UTIL_EVENT_CALLBACK || {}, o.off(n, "*[" + e + "]", i
						.event.UTIL_EVENT_CALLBACK[e]), i.event.UTIL_EVENT_CALLBACK[e] = function() {
						var i = t(this),
							n = i.attr(e);
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	var t = layui.$,
		...
		s = function(e) {
			var t = c.config[e];
			return t || o.error(e ? "The table instance with ID '" + e + "' not found" :
		...
		E = [
			...
			"</div>", "{{# } }}", "{{# var left, right; }}", '<div class="layui-table-header">', _(), "</div>",
	...
	I.prototype.config = {
			...
			a.height && /^full-\d+$/.test(a.height) && (e.fullHeightGap = a.height.split("-")[1], a.height = j
			...
			if (a.index = e.index, e.key = a.id || a.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(
				...
				.find(k), e.layFixed = o.find(w), e.layFixLeft = o.find(T), e.layFixRight = o.find(N), e
				.layTotal = o.find(A), e.layPage = o.find(L), e.renderToolbar(), e.fullSize(), a.cols.length > 1
				) {
			...
			var a = this;
			e = e || {}, delete a.haveInit, e.data && e.data.constructor === Array && delete a.config.data, a
				.config = t.extend(i, {}, a.config, e), a.render()
			...
			if (i.startTime = (new Date).getTime(), a.url) {
				...
				var c = {},
					s = e * a.limit - a.limit;
				c[n.dataName] = a.data.concat().splice(s, a.limit), c[n.countName] = a.data.length, "object" ==
					typeof a.totalRow && (c[n.totalRowName] = t.extend({}, a.totalRow)), i.renderData(c, e, c[n
						.countName]), o(), i.setColsWidth(), "function" == typeof a.done && a.done(c, e, c[n
						.countName])
			}
							...
							function(a, l) {
								...
								0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n,
										...
										if (void 0 !== m && null !== m || (m = ""), !r.colGroup) {
											...
											o.push(g), r.fixed && "right" !== r.fixed && y.push(g),
												"right" === r.fixed && h.push(g)
										}
									}), v.push('<tr data-index="' + a + '">' + o.join("") + "</tr>"), m
									.push('<tr data-index="' + a + '">' + y.join("") + "</tr>"), g.push(
										'<tr data-index="' + a + '">' + h.join("") + "</tr>"))
							}), c.layBody.scrollTop(0), c.layMain.find("." + p).remove(), c.layMain.find(
							"tbody").html(v.join("")), c.layFixLeft.find("tbody").html(m.join("")), c
			...
			return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" :
				"removeClass"](f), 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed
				.removeClass(f), r ? b() : (b(), c.renderTotal(y, h), void(s.page && (s.page = t.extend({
					...
					var c = d.field || e,
						s = function() {
							var e, t = d.totalRowText || "",
								...
								l = {};
							return l[c] = i, e = d.totalRow ? u(d, i, l) || t : t, a ? a[d.field] || e :
								e
						}(),
						y = ['<td data-field="' + c + '" data-key="' + n.index + "-" + d.key + '" ' +
							function() {
								var e = [];
								return d.align && e.push('align="' + d.align + '"'), d.style && e.push(
									'style="' + d.style + '"'), d.minWidth && e.push(
									'data-minwidth="' + d.minWidth + '"'), e.join(" ")
							}() + ' class="' + function() {
								var e = [];
								return d.hide && e.push(f), d.field || e.push(
			...
			var e, t = this,
				i = t.config,
				a = i.height;
			t.fullHeightGap && (a = j.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height",
			...
			i.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
				...
				}), i.setThisRowChecked(o), layui.event.call(this, y, "radio(" + p + ")", v.call(
					this, {
						checked: l
					}))
	...
	v.prototype.config = {
		...
		i.children("li").each(function(e) {
			...
			v.on("click", function(e) {
				...
				l.text && i.next("span").text(l.value + "星"), l.choose && l.choose(l.value),
